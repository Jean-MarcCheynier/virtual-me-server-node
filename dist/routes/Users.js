...
exports.getConnectedUsers = exports.getMe = exports.deleteOneUser = exports.updateOneUser = exports.addOneUser = exports.getAllUsers = void 0;
...
function getMe(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        const user = req.user;
        yield userDao.getOne({ _id: user._id });
        return res.status(OK).end();
    });
}
exports.getMe = getMe;
...
function getConnectedUsers(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        const connectedUsers = yield userDao.getConnectedUsers();
